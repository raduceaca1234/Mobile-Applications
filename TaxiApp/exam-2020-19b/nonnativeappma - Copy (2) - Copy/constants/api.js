...
export const fetchVolunteers = () => fetch('http://10.0.2.2:1957/all').then(res => res.json());

export const fetchPaints = () => fetch('http://10.0.2.2:1957/colors').then(res => res.json());

export const fetchVolunteersMe = ({driver}) => fetch('http://10.0.2.2:1957/my/' + driver).then(res => res.json());

export const fetchVolunteersColor = ({color}) => fetch('http://10.0.2.2:1957/cabs/' + color).then(res => res.json());
