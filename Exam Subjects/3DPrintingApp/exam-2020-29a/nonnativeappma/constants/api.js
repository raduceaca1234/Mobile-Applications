...
export const fetchVolunteers = () => fetch('http://10.0.2.2:2901/all').then(res => res.json());
...
export const fetchVolunteersMe = ({ driver }) => fetch('http://10.0.2.2:2901/models/' + driver).then(res => res.json());
