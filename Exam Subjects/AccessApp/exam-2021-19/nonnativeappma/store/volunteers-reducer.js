import { SET_LEVELS, SET_DETAILS, SET_LOCATIONS2, SET_LOCATIONS, SET_PAINT, SET_NAME, SET_ME, ADD_NAME, ADD_VOLUNTEER, DELETE_VOLUNTEER, SET_VOLUNTEERS, UPDATE_VOLUNTEER, ADD_OPERATION, SET_VOLUNTEERS_FROM_SERVER, DELETE_OPERATIONS } from './volunteers-actions';
...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case SET_LEVELS:
      return {
        ...state, levels: action.volunteers
      };
    case SET_DETAILS:
      return {
    ...
    case ADD_VOLUNTEER:
      const newPlace = new Volunteer(
        ...
        action.placeData.level,
        action.placeData.status,
        action.placeData.from,
        action.placeData.to
      );
      return {
