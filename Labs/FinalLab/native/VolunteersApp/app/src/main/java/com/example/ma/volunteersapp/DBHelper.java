...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String database_name = "volunteers_db";
    public static final String table_name = "tabel_volunteers";
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + table_name + "(" + row_id + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + row_name + " TEXT," + row_phone + " TEXT, " + row_created + " TEXT)";
        db.execSQL(query);
    }
